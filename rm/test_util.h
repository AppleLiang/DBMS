...
void prepareTupleWithSSN(const int nameLength, const string &name, const int age, const float height, const int salary, int ssn, void *buffer, int *tupleSize)
{
    int offset = 0;
...
void printTupleWithSSN(const void *buffer, const int tupleSize)
{
    int offset = 0;
